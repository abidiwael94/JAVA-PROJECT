    ...
    public static void main(String[] args) {
        ...
        try (Connection connection = DriverManager.getConnection(url, user, password);
            ...
            String createTableInscriptionSQL = "CREATE TABLE IF NOT EXISTS inscription ( " +
                    ...
                    "  FOREIGN KEY (id_matiere,id_enseignant) REFERENCES groupe(id_matiere,id_enseignant), " +
                    "  PRIMARY KEY (id_etudiant,id_matiere,id_enseignant) " +
                    ");";
            ...
            String createTableAbsenceSQL = "CREATE TABLE IF NOT EXISTS absence ( " +
                    ...
                    "  id_salle INT NOT NULL, " +
                    "  motif VARCHAR(255), " +
                    "  PRIMARY KEY (id_etudiant,id_matiere,id_enseignant,id_salle), " +
                    "  FOREIGN KEY (id_matiere, id_enseignant, id_salle) REFERENCES seance(id_matiere, id_enseignant, id_salle) \n" +
                    ");";
